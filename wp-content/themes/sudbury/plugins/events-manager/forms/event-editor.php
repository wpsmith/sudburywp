<?php
/**
 * Overrides the Default Event Editor template with some modifications for the sudbury theme
 *
 * Note the Warning from the Events-manager Developer but it is outdated by 2+ years. Recommending extreme caution
 * when updating the events-manager plugin
 *
 * @see     wp-content/plugins/events-manager/templates/forms/event-editor.php
 *
...
if ( is_object( $EM_Event ) && ! $EM_Event->can_manage( 'edit_events', 'edit_others_events' ) ) {
	?>
	<div class="wrap"><h2><?php esc_html_e( 'Unauthorized Access', 'dbem' ); ?></h2>

		<p><?php echo sprintf( __( 'You do not have the rights to manage this %s.', 'dbem' ), __( 'Event', 'dbem' ) ); ?></p>
	</div>
	<?php
	return false;
...
<style type="text/css">
	#qt_em-editor-content_toolbar, #wp-em-editor-content-editor-tools {
		display: none;
	}
	...
	<div class="wrap">
		...
		<?php if ( get_option( 'dbem_locations_enabled' ) ): ?>
			...
			<div class="inside event-form-where">
				...
				<p>If the location is not in the list, please describe it in your details</p>
			</div>
		<?php endif; ?>
		...
		<div class="inside event-form-details">
			...
			<i>Links in this section don't work</i>
			<ul>
				<li>If this event is a charitable walk/run please complete and email this form to the Selectmen's Office</li>
				<li>If this event requires a 1 day liquor license please complete and email this form to the Selectmen's Office</li>
				<li>If this event is a charitable walk/run please complete and email this form to the Selectmen's Office</li>
			</ul>
