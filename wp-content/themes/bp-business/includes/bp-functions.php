...
function bp_dtheme_enqueue_scripts() {
	...
	$params = array(
		'my_favs'           => __( 'My Favorites', TEMPLATE_DOMAIN ),
		'accepted'          => __( 'Accepted', TEMPLATE_DOMAIN ),
		'rejected'          => __( 'Rejected', TEMPLATE_DOMAIN ),
		'show_all_comments' => __( 'Show all comments for this thread', TEMPLATE_DOMAIN ),
		'show_all'          => __( 'Show all', TEMPLATE_DOMAIN ),
		'comments'          => __( 'comments', TEMPLATE_DOMAIN ),
		'close'             => __( 'Close', TEMPLATE_DOMAIN ),
		'view'              => __( 'View', TEMPLATE_DOMAIN )
	);
