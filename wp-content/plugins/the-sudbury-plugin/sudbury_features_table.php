<?php
/**
 * @deprecated 2014-07-16 No Longer Used
 */

/**
 * Customizes the Extra Features Table
 * Class Sudbury_Features_Table
 */
class Sudbury_Features_Table extends WP_List_Table {
	...
	function get_columns() {
		return $columns = array(
			'col_link_id'   => __( 'Feature Name' ),
			'col_link_name' => __( 'Enabled' ),
			'col_link_url'  => __( 'Number of Sites' ),
		);
	}
