...
/**
 * Sudbury events list widget
 *
 * @author Eddie Hurtig <hurtige@sudbury.ma.us>, marcus
 */
class Sudbury_Events extends EM_Widget {
	...
	function __construct() {
		...
		parent::__construct( false, $name = 'Sudbury - Events', $widget_ops );
	}
