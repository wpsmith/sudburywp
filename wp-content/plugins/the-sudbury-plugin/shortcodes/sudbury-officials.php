...
class Sudbury_Officials_Shortcode {
	...
	/**
	 * Register the officials Shortcode
	 */
	function init() {
		add_shortcode( 'officials', array( &$this, 'shortcode' ) );
	}
	...
	function shortcode( $atts, $content = '' ) {
		...
		<div class="officials">
			...
			<?php endforeach; ?>
			<?php else : ?>
				<div class="error danger">Officials Not loaded from Filemaker</div>
			<?php endif; ?>
		</div>
		<?php
...
new Sudbury_Officials_Shortcode();
