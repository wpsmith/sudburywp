...
class EM_Event extends EM_Object{
	...
	function load_postdata($event_post, $search_by = false){
		...
		if( is_object($event_post) && ($event_post->post_type == 'event-recurring' || $event_post->post_type == EM_POST_TYPE_EVENT || $event_post->post_type == 'meeting' || $event_post->post_type == 'post') ){
